...
export class HomeComponent implements OnInit, AfterViewInit {
  ...
  menuItems: any = [
    ...
    { name: 'services', label: 'Services', route: '/home/services', clickedOn: false },
    { name: 'contacts', label: 'Contacts', route: '/home/contacts', clickedOn: false },
  ]
  section: any;
  icons: any[] = [{ name: 'LinkedIn icon', iconLink: '../../../assets/linkedin.svg', tooltip: 'Check our linkedIn', link: 'https://www.linkedin.com/company/novaline-digital/' },
  { name: 'Facebook icon', iconLink: '../../../assets/facebook.svg', tooltip: 'Check our facebook', link: 'https://web.facebook.com/profile.php?id=61585636196012' }, { name: 'Instagram icon', iconLink: '../../../assets/instagram.svg', tooltip: 'Check my instagram account', link: '/' }];
